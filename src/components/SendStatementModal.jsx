...
const SendStatementModal = ({
  ...
  const fillPlaceholders = (text = '') => {
    ...
    return text
      ...
      .replace(/{companyName}/g, settings?.companyName || 'RC Accountant Services')
  ...
  const handleSendWhatsApp = () => {
    ...
    if (includePdfAttachment) {
      waText += `\n\n📎 Official Statement & Details: Generated by RC Accountant Portal.`;
    }
  ...
  const handleDownloadPDF = () => {
    const content = `=====================================================
RC ACCOUNTANT SERVICES - OFFICIAL LOAN STATEMENT
=====================================================
...
=====================================================
RC Accountant Services Ltd. • Computer Generated Copy
=====================================================`;
    ...
    if (window.confirm(`Send ${targets.length} reminders via ${targetChannel}?`)) {
      targets.forEach((c) => {
        ...
        const msg = tmpl.body
          ...
          .replace(/{companyName}/g, settings?.companyName || 'RC Accountant');
        ...
        loanStore.addCommunication({
          ...
          subject: `EMI Reminder - ${custLoan?.loanName || 'RC Accountant'}`,
          message: msg,
          status: 'Sent',
          hasAttachment: true,
        });
